...
\begin{itemize}
    ...
    \item
    (schnelle) Anpassung vegetativer Funktionen des Körpers an aktuelle Erfordernisse, Koordination von Organfunktion: essentiell für Überleben
\end{itemize}
...
\begin{itemize}
    ...
    \item
    Koerperhomöostase  (Aufrechterhaltung und Anpassung physiologischer Parameter)
    \item
    Vegetative Reflexe
    \item
    ...
    \begin{itemize}
        ...
        Herzmuskulatur
        \item
        Drüsen und sektretorische Gewebe
    \end{itemize}
